 ...
 *   import_id?: int,
 *     // The post ID to be used when inserting a new post. If specified, must not match any existing post ID. Default 0.
 *   post_category?: int[],
 *     // Array of category IDs. Defaults to value of the 'default_category' option.
 *   tags_input?: array,
 *     // Array of tag names, slugs, or IDs. Default empty.
 *   tax_input?: array,
 *     // An array of taxonomy terms keyed by their taxonomy name. If the taxonomy is hierarchical, the term list needs to
 *     // be either an array of term IDs or a comma-separated string of IDs. If the taxonomy is non-hierarchical, the term
 *     // list can be an array that contains term names or slugs, or a comma-separated string of names or slugs. This is
 *     // because, in hierarchical taxonomy, child terms can have the same names with different parent terms, so the only
 *     // way to connect them is using ID. Default empty.
 *   meta_input?: array,
 *     // Array of post meta values keyed by their post meta key. Default empty.
 *   page_template?: string,
 *     // Page template to use.
 * } $postarr An array of elements that make up a post to update or insert.
