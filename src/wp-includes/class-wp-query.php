...
class WP_Query {
	 ...
	 *   comment_count?: int|array{value: int, compare?: ('='|'!='|'>'|'>='|'<'|'<=')},
	 *     // Filter results by comment count. Provide an integer to match comment count exactly. Provide an array with
	 *     // integer 'value' and 'compare' operator to compare against comment_count in a specific way.
	 ...
	 *   meta_compare?: string,
	 *     // MySQL operator used for comparing the meta value. See WP_Meta_Query::__construct() for accepted
	 *     // values and default value.
	 *   meta_compare_key?: string,
	 *     // MySQL operator used for comparing the meta key. See WP_Meta_Query::__construct() for accepted
	 *     // values and default value.
	 *   meta_type?: string,
	 ...
	 *     // Sort retrieved posts by parameter. One or more options may be passed. To use 'meta_value' or
	 *     // 'meta_value_num', 'meta_key=keyname' must be also be defined. To sort by a specific `$meta_query` clause,
	 ...
	 *     // The number of posts to query for by archive page. Overrides 'posts_per_page' when is_archive(),
	 *     // or is_search() are true.
	 *   s?: string,
	 *     // Search keyword(s). Prepending a term with a hyphen will exclude posts matching that term.
	 *     // Eg, 'pillow -sofa' will return posts containing 'pillow' but not 'sofa'. The character used for
	 *     // exclusion can be modified using the the 'wp_query_search_exclusion_prefix' filter.
	 ...
	 *   tag_slug__in?: string[],
	 *     // An array of tag slugs (OR in), unless 'ignore_sticky_posts' is true. Note: a string of comma-separated IDs
	 *     // will NOT work.
	 *   tax_query?: mixed[],
	 ...
	 *     // get_term_meta() call will hit the database. Defaults to the value of `$update_post_term_cache`.
	 *   w?: int<0,53>,
	 ...
	 * }|string $query Array or string of query parameters.
	 */
